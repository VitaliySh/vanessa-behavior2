...
Процедура ЗагрузитьНастройкиВРежимеКоманднойСтроки(ОбъектЯдра, СтруктураДействий) Экспорт
	...
	Если StartFeaturePlayer = Истина Тогда
		...
		ОбъектЯдра.ЗаписьВидеоСловарьЗамен                                 = КонтекстЯдра.ПреобразоватьПутьСТочкамиКНормальномуПути(ПолучитьЗначениеПереданногоПараметра(СтрутктураJSON, "ЗаписьВидеоСловарьЗамен"));
