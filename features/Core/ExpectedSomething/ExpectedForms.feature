...
#Область Проверка созданного кода Gherkin по изменениям элементов формы
	...
	# В 8.3.10.2634 для дат стало возвращать не 08.04.1981 0:00:00, а 08.04.1981 00:00:00 , т.е. в часе 2 нуля.
	Тогда В реквизите Vanessa-Behavior "СгенерированныйСценарий" будет содержаться строка 'элемент формы с именем "РеквизитДата" стал равен "08.04.1981 0'
