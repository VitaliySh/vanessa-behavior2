...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуТекст(Парам01,Парам02)","ВПолеЯВвожуТекст","И     в поле ""ИмяПоля"" я ввожу текст ""Значение поля""","Вводит текст в поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуЗначениеВыражения(Парам01,Парам02)","ВПолеЯВвожуЗначениеВыражения","И в поле ""ИмяПоля"" я ввожу значение выражения ""1+1""","Вычисляет выражение и вводит результат в поле","UI.Формы.Поля");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеСИменемЯВвожуЗначениеВыражения(Парам01,Парам02)","ВПолеСИменемЯВвожуЗначениеВыражения","И в поле с именем ""ИмяПоля"" я ввожу значение выражения ""1+1""","Вычисляет выражение и вводит результат в поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаСталаРавной(Парам01,ТабПарам)","ТаблицаСталаРавной","И таблица ""ИмяТаблицы"" стала равной:" + Символы.ПС + "	| ИмяКолонки1 | ИмяКолонки2 |" + Символы.ПС + "	| Значение1 | Значение2 |","Проверяет, что таблица TestClient стала равна таблице Gherkin","UI.Таблицы.Проверка значения таблицы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТаблицаСталаРавнойМакету(Парам01,Парам02)","ТаблицаСталаРавнойМакету","И таблица ""ИмяТаблицы"" стала равной макету ""ИмяМакета""","Проверяет, что таблица TestClient стала равна переданному макету","UI.Таблицы.Проверка значения таблицы");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоТаблицаСтанетРавнаДаннойВТеченииСекунд(Парам01,Парам02,ТабПарам)","ЯЖдуЧтоТаблицаСтанетРавнаДаннойВТеченииСекунд","И я жду, что таблица ""ИмяТаблицы"" станет равна данной в течении 20 секунд:","Проверяет, что таблица TestClient станет равной таблице Gherkin в течении нужного числа секунд","UI.Таблицы.Ожидание значения таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуВыбораУПоля(Парам01)","ЯНажимаюКнопкуВыбораУПоля","И     я нажимаю кнопку выбора у поля ""Имя поля""","Нажимает на кнопку выбора у поля","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуВыбораУПоляСИменем(Парам01)","ЯНажимаюКнопкуВыбораУПоляСИменем","И     я нажимаю кнопку выбора у поля с именем ""ИмяПоля""","Нажимает на кнопку выбора у поля","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТабличныйДокументСталРавен(Парам01,ТабПарам)","ТабличныйДокументСталРавен","И табличный документ ""РеквизитТабличныйДокумент"" стал равен:" + Символы.ПС + "	| Значение1 | Значение2 |" + Символы.ПС + "	| Значение3 | Значение4 |","Проверяет равенство табличного документа переданной таблице Gherkin. Чтобы получить mxl файл из TestClient, в тонком клиенте будет сделана попытка сохранить табличный документ в файл. В Web клиенте он всегда будет считываться по ячейкам. Детали в справке, в разделе, посвященному сравнению табличного документа с эталоном.","UI.Табличный документ.Проверка значения табличного документа.Таблица Gherkin");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯАктивизируюОкно(Парам01)","ЯАктивизируюОкно","И я активизирую окно ""ИмяФормы""","Активизирует окно с нужным заголовком","UI.Окна");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЗакрытияОкнаВТеченииСекунд(Парам01,Парам02)","ЯЖдуЗакрытияОкнаВТеченииСекунд","И я жду закрытия окна ""Имя окна"" в течении 600 секунд","Ожидает, что окно исчезнет в течении указанного числа секунд","UI.Окна");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуОткрытияОкнаВТеченииСекунд(Парам01,Парам02)","ЯЖдуОткрытияОкнаВТеченииСекунд","И я жду открытия окна ""Имя окна"" в течении 600 секунд","Ожидает, что окно появится в течении указанного числа секунд","UI.Окна");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеСИменемЯВвожуТекст(Парам01,Парам02)","ВПолеСИменемЯВвожуТекст","И     в поле с именем ""ИмяПоля"" я ввожу текст ""Значение поля""","Вводит текст в поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯАктивизируюПоле(Парам01)","ЯАктивизируюПоле","И я активизирую поле ""Имя поля""","Сделать поле активным","UI.Формы.Поля.Активность");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯАктивизируюПолеСИменем(Парам01)","ЯАктивизируюПолеСИменем","И я активизирую поле с именем ""ИмяПоля""","Сделать поле активным","UI.Формы.Поля.Активность");

	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСталРавен(Парам01,Парам02)","ЭлементФормыСталРавен","Тогда элемент формы ""ИмяПоля"" стал равен ""Значение поля""","Проверка значения элемента формы","UI.Формы.Проверка значения элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементФормыСИменемСталРавен(Парам01,Парам02)","ЭлементФормыСИменемСталРавен","Тогда элемент формы с именем ""ИмяПоля"" стал равен ""Значение поля""","Проверка значения элемента формы","UI.Формы.Проверка значения элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"УЭлементаФормыСИменемТекстРедактированияСталРавен(Парам01,Парам02)","УЭлементаФормыСИменемТекстРедактированияСталРавен","И у элемента формы с именем ""ИмяПоля"" текст редактирования стал равен ""ТекстПоля""","Проверка значения текста редактирования элемента формы","UI.Формы.Проверка значения элемента");
	
	//Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЭлементТаблицыСталРавен(Парам01,Парам02,Парам03)","ЭлементТаблицыСталРавен","Тогда элемент таблицы ""Таблица"" ""ИмяПоля"" стал равен ""Значение поля""","Проверка значения реквизита таблицы","UI.Таблицы.Ожидание значения элемента");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд(Парам01,Парам02,Парам03)","ЯЖдуЧтоУГруппыСтраницТекущейСтраницейСтанетВТеченииСекунд","И я жду, что у группы страниц ""ГруппаСтраниц"" текущей страницей станет ""ИмяСтраницы"" в течении 20 секунд","Ожидает, что у заданной группы текущей страницей станет нужная группа в течении указанного числа секунд","UI.Формы.Группы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюЗначениеРеквизитаИзФормыСписка(Парам01)","ЯВыбираюЗначениеРеквизитаИзФормыСписка","И     я выбираю значение реквизита ""ИмяПоля"" из формы списка","Нажимает на кнопку ""Выбрать из списка"" у поля","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯВыбираюЗначениеРеквизитаСИменемИзФормыСписка(Парам01)","ЯВыбираюЗначениеРеквизитаСИменемИзФормыСписка","И     я выбираю значение реквизита с именем ""ИмяПоля"" из формы списка","Нажимает на кнопку ""Выбрать из списка"" у поля","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуОчиститьУПоля(Парам01)","ЯНажимаюКнопкуОчиститьУПоля","И     я нажимаю кнопку очистить у поля ""ИмяПоля""","Очищает поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНажимаюКнопкуОчиститьУПоляСИменем(Парам01)","ЯНажимаюКнопкуОчиститьУПоляСИменем","И     я нажимаю кнопку очистить у поля с именем ""ИмяПоля""","Очищает поле","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯБудуВыбиратьВнешнийФайл(Парам01)","ЯБудуВыбиратьВнешнийФайл","И     я буду выбирать внешний файл ""ИмяФайла""","Устанавливает результат диалога выбора файла.","Файлы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПерехожуКСледующемуРеквизиту()","ЯПерехожуКСледующемуРеквизиту","И     я перехожу к следующему реквизиту","Переходит к следующему реквизиту формы","UI.Формы.Поля");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляКак(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляКак","И     я запоминаю значение поля ""ИмяПоля"" как ""ПеременнаяНомерДокумента""","Сохранение значения поля в переменную Контекст","Контекст.Контекст.Сохранить значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеТаблицыПоляКак(Парам01,Парам02,Парам03)","ЯЗапоминаюЗначениеТаблицыПоляКак","И     я запоминаю значение таблицы ""ИмяТаблицы"" поля ""ИмяПоля"" как ""ПеременнаяНомерДокумента""","Сохранение значения поля таблицы в переменную Контекст","Контекст.Контекст.Сохранить значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляСКлючом(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляСКлючом","И     я запоминаю значение поля ""ИмяПоля"" с ключом ""Номер документа""","Сохранение значения поля в переменную Контекст с произвольным ключом","Контекст.Контекст.Сохранить значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляКакГлобально(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляКакГлобально","И     я запоминаю значение поля ""ИмяПоля"" как ""НомерДокумента"" глобально","Сохранение значения поля в переменную КонтекстСохраняемый","Контекст.Контекст сохраняемый.Сохранить значение");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюЗначениеПоляСКлючомГлобально(Парам01,Парам02)","ЯЗапоминаюЗначениеПоляСКлючомГлобально","И     я запоминаю значение поля ""ИмяПоля"" с ключом ""Номер документа"" глобально","Сохранение значения поля в переменную КонтекстСохраняемый с произвольным ключом","Контекст.Контекст сохраняемый.Сохранить значение");
	
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗапоминаюТекущееОкноКак(Парам01)","ЯЗапоминаюТекущееОкноКак","И я запоминаю текущее окно как ""НужныйМнеЗаголовокОкна""","Сохранение значения заголовка текущего окна в переменную Контекст","Контекст.Контекст.Сохранить значение");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоВОкнеВТаблицеКоличествоСтрокБудетВТеченииСекунд(Парам01,Парам02,Парам03,Парам04,Парам05)","ЯЖдуЧтоВОкнеВТаблицеКоличествоСтрокБудетВТеченииСекунд","И я жду, что в окне ""ЗаголовокОкна"" в таблице ""ИмяТаблицы"" количество строк будет ""больше"" 0 в течении 20 секунд","В течении нужного числа секунд проверяется количество строк в таблице в нужном окне","UI.Таблицы.Ожидание значения таблицы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд(Парам01,Парам02,Парам03,Парам04)","ЯЖдуЧтоВТаблицеКоличествоСтрокБудетВТеченииСекунд","И я жду, что в таблице ""ИмяТаблицы"" количество строк будет ""больше"" 0 в течении 20 секунд","В течении нужного числа секунд проверяется количество строк в таблице в текущем окне","UI.Таблицы.Ожидание значения таблицы");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаВТеченииСекунд(Парам01, Парам02)", 			"ЯЖдуПоявленияЭлементаВТеченииСекунд", 			"И я жду появления элемента ""Имя элемента"" в течении ""Таймаут"" секунд","Ожидание появления элемента формы с нужным заголовком в течении указанного числа секунд","UI.Формы.Ожидание появления элемента");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуПоявленияЭлементаСИменемВТеченииСекунд(Парам01, Парам02)", 	"ЯЖдуПоявленияЭлементаСИменемВТеченииСекунд", 	"И я жду появления элемента с именем ""ИмяЭлемента"" в течении ""Таймаут"" секунд","Ожидание появления элемента формы с нужным именем в течении указанного числа секунд","UI.Формы.Ожидание появления элемента");
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВПолеЯВвожуТекстИзМакета(Парам01,Парам02)","ВПолеЯВвожуТекстИзМакета","И в поле ""СгенерированныйXML"" я ввожу текст из макета ""Xml1""","Вводит текст в поле. Текст будет взят из макета","UI.Формы.Поля");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд(Парам01,Парам02)","ЯЖдуЧтоПолеПерестанетБытьПустымВТеченииСекунд","И я жду, что поле ""СгенерированныйСценарий"" перестанет быть пустым в течении 30 секунд","Проверяет, что в течении нужного числа секунд текстовое поле станет заполненным.","UI.Формы.Поля");
...
&НаКлиенте
Функция СтрокаСоответствуетШаблону(ПроверяемаяСтрока, Знач Шаблон)
...
Функция ПолучитьРасхожденияТДRegExp(Макет, ТабПарам)
	...
	Для Каждого СтрокаОжидаемая Из ТабПарам Цикл
		...
		Если ЗначениеПараметраМакета = Неопределено Тогда
			...
			МассивРасхождений.Добавить(СтрокаРасхождения);
		ИначеЕсли Не СтрокаСоответствуетШаблону(ЗначениеПараметраМакета, ЗначениеПараметра) Тогда
...
Процедура ВТабличномДокументеЗначенияВКолонкеСоответствуютУсловию(ИмяЭлементаФормы,ИмяКолонки,ВидСравнения,Значение) Экспорт
	...
	ПроверитьЗначениеКолонкиНаЗначениеУсловия(ТабДок,ИмяКолонки,ВидСравнения,Значение);
